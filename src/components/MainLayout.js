...
import { BiCategoryAlt, BiSolidPhoneCall } from "react-icons/bi";
      ...
      <Sider trigger={null} collapsible collapsed={collapsed}>
        ...
        <Menu
          ...
          items={[
            ...
            {
              key: "enquiries",
              icon: <BiSolidPhoneCall className="fs-4" />,
              label: "Enquiries",
            },
          ]}
        />
            ...
            <div className="d-flex gap-4 align-items-center dropdown">
              <div>
                <img
                  width={32}
                  height={32}
                  src="https://i.imgur.com/DaE1hnF.jpg"
                  alt=""
                />
              </div>
              <div
                ...
                aria-expanded="false"
              >
                <h5 className="mb-0">Eshan</h5>
                <p className="mb-0">eshangpkhairwar@gmail.com</p>
              </div>
